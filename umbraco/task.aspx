<%@ Page trace="true" language="c#" Codebehind="task.aspx.cs" AutoEventWireup="True" Inherits="umbraco.cms.presentation.theTask" %>
...
<HTML>
	...
	<body>
		<form id="dataForm" method="post" runat="server">
			<input type="text" id="nodeID" runat="server"> <input type="text" id="nodeType" runat="server">
			<input type="text" id="task" runat="server"> <input type="text" id="parameterName" runat="server">
